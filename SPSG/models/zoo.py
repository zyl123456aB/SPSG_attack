...
import SPSG.models.cifar
import SPSG.models.mnist
import SPSG.models.imagenet
...
def get_net(modelname, modeltype, pretrained=None, **kwargs):
    ...
    if pretrained and pretrained is not None:
        ...
        try:
            ...
            model = eval('SPSG.models.{}.{}'.format(modeltype, modelname))(**kwargs)
            ...
            model = eval('SPSG.models.{}.{}'.format(modeltype, modelname))()
...
def get_pretrainednet(modelname, modeltype, pretrained='imagenet', num_classes=1000, **kwargs):
    if pretrained == 'imagenet':
        ...
        try:
            # This should have ideally worked:
            model = eval('SPSG.models.{}.{}'.format(modeltype, modelname))(num_classes=num_classes, **kwargs)
        except AssertionError:
...
def get_imagenet_pretrainednet(modelname, num_classes=1000, **kwargs):
    valid_models = SPSG.models.imagenet.__dict__.keys()
    assert modelname in valid_models, 'Model not recognized, Supported models = {}'.format(valid_models)
    model = SPSG.models.imagenet.__dict__[modelname](pretrained='imagenet')
    if num_classes != 1000:
